# Script to assist with nwmagentapmx development
#
...
class Server(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if ext == "css":
            data = open(os.path.join(DIR_SASS, "nwmagentapmx.css"), "rb").read()
            type = "text/css"
        elif ext == "js":
            data = open(os.path.join(DIR_JS, "nwmagentapmx.js"), "rb").read()
